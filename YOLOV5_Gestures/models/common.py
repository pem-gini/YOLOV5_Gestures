...
from YOLOV5_Gestures.utils.datasets import exif_transpose, letterbox
from YOLOV5_Gestures.utils.general import (LOGGER, check_requirements, check_suffix, colorstr, increment_path, make_divisible,
                           non_max_suppression, scale_coords, xywh2xyxy, xyxy2xywh)
from YOLOV5_Gestures.utils.plots import Annotator, colors, save_one_box
from YOLOV5_Gestures.utils.torch_utils import time_sync
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=True):
        ...
        if jit:  # TorchScript
            ...
            from YOLOV5_Gestures.models.experimental import attempt_load  # scoped to avoid circular import
